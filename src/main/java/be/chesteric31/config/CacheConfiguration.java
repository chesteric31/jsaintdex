...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, be.chesteric31.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, be.chesteric31.repository.UserRepository.USERS_BY_EMAIL_CACHE);
