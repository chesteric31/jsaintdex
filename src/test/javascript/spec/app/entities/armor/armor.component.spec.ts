...
import { ArmorComponent } from 'app/entities/armor/armor.component';
import { ArmorService } from 'app/entities/armor/armor.service';
import { Armor } from 'app/shared/model/armor.model';

describe('Component Tests', () => {
  describe('Armor Management Component', () => {
    let comp: ArmorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ArmorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.armors && comp.armors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
