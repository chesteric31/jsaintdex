...
import { StrengthComponent } from 'app/entities/strength/strength.component';
...
describe('Component Tests', () => {
  describe('Strength Management Component', () => {
    let comp: StrengthComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StrengthComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.strengths && comp.strengths[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
